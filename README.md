...
bash_command = ["cd /home/dlebedev/GIT/devops-netology", "git status"]
result_os = os.popen(' && '.join(bash_command)).read()
#is_change = False
for result in result_os.split('\n'):
...
```
root@DonTtouch:/home/dlebedev/GIT/devops-netology# ./skript.py
/home/dlebedev/GIT/devops-netology/	изменено:      README.md
/home/dlebedev/GIT/devops-netology/	изменено:      README.md
...
### Вывод скрипта при запуске при тестировании:
```
root@DonTtouch:/home/dlebedev/GIT/devops-netology# ./skript2.py
Введите полный путь к репозиторию(со знаком '/' в конце):
/home/dlebedev/GIT/devops-netology/
/home/dlebedev/GIT/devops-netology/	изменено:      README.md
/home/dlebedev/GIT/devops-netology/	изменено:      README.md
```
...
### Вывод скрипта при запуске при тестировании:
```
root@DonTtouch:/home/dlebedev/GIT/devops-netology# ./skript_http.py
